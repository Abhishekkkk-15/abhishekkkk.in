    ...
    <section
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        <div className="mb-8 fade-in-up stagger-1">
          <img
            src="https://avatars.githubusercontent.com/u/164181412?s=400&u=9a50ae006ddac2f963b40b78317de5fec35b4366&v=4"
            className="w-24 h-24 mx-auto  rounded-2xl flex items-center justify-center text-stone-50 text-2xl font-light shadow-lg hover:scale-105 transition-transform duration-300"
          />
        </div>
        ...
        <div className="flex items-center justify-center gap-4 mb-16 fade-in-up stagger-4">
          ...
          <a
            href="https://www.linkedin.com/in/abhishek-jangid-3532b1323m"
            target="_blank"
            rel="noopener noreferrer"
            className="p-3 border border-black/20 rounded-full hover:bg-black hover:text-stone-50 hover:border-black transition-all hover-lift group">
            <Linkedin
